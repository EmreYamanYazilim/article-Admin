        ...
        <x-slot:body>
            ...
            <div class="example-container">
                <div class="example-content">
                    ...
                    <form action="{{ isset($category) ? route("category.edit",["id" =>$category->id]) : route("category.create") }}" method="post" >
                        @csrf
                    <input type="text"
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="status" id="status" {{ isset($category) && $category->status ? "checked" : "" }}>
                        <label class="form-check-label" for="status">
                            Kategori Sitede Görünsün mü ?
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="feature_status"  id="feature_status" {{ isset($category) && $category->feature_status ? "checked" : "" }}>
